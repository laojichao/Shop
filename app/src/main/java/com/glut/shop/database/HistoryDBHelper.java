...
public class HistoryDBHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME = "history_info"; // 表的名称
    ...
    // 利用单例模式获取数据库帮助器的唯一实例
    public static HistoryDBHelper getInstance(Context context, int version) {
        if (version > 0 && mHelper == null) {
            mHelper = new HistoryDBHelper(context, version);
